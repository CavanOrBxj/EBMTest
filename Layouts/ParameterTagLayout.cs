    ...
    public partial class ParameterTagLayout : UserControl
    {
            ...
            if (list != null)
            {
                foreach (var s in list)
                {
                    bindList.Add(new Parameter { Value = s,
                        ValueString = Utils.ComboBoxHelper.GetTypeStringValue(Enums.ParamType.ConfigStatusParameterTag, s),
                    });
                }
            }
            dgvParameterTag.DataSource = bindList;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            bindList.Add(new Parameter { Value = (byte)cbBoxParameterTag.SelectedValue,
                ValueString = Utils.ComboBoxHelper.GetTypeStringValue(Enums.ParamType.ConfigStatusParameterTag, (byte)cbBoxParameterTag.SelectedValue),
            });
        }
