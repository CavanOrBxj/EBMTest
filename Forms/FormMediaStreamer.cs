...
namespace EBMTest.Forms
{
    public partial class FormMediaStreamer : Form
    {
        ...
        private Process processCppPlayer;
        ...
        private void OpenMediaStreamer(object param)
        {
            try
            {
                ...
                processCppPlayer = new Process();
                processCppPlayer.StartInfo.FileName = "cppPlayer.exe";
                processCppPlayer.StartInfo.WorkingDirectory = path;
                processCppPlayer.StartInfo.Arguments = argument;
                processCppPlayer.Start();
                ...
                if (processCppPlayer != null)
                {
                    try
                    {
                        processCppPlayer.Kill();
                        processCppPlayer.Close();
                        processCppPlayer.Dispose();
                    }
                    catch { }
                }
                processCppPlayer = null;
